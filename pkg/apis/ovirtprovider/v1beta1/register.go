...
// +k8s:conversion-gen=github.com/uccps-samples/cluster-api-provider-ovirt/pkg/apis/ovirtprovider
// +k8s:defaulter-gen=TypeMeta
// +groupName=ovirtprovider.machine.uccp.io
package v1beta1
...
var (
	...
	SchemeGroupVersion = schema.GroupVersion{Group: fmt.Sprintf("%s.machine.uccp.io", GroupName), Version: "v1beta1"}
